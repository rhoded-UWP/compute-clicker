...
DATA.projects = [
  ...
  { id:'app',        name:'MOBILE APP',           value:15, theme:'skeuo',
...
DATA.codeSnippetsByTheme = {
  ...
  skeuo: [
    ...
    '// removed ads (in-app purchase $0.99)',
    '[appStore submitForReview]; // pray',
    '[self release]; // crash later, mysteriously',
    /* ---- easter eggs: real lines from this game ---- */
    'const PRESS_COOLDOWN_MS = 80;',
    "el.classList.add('bought-flash');",
    'G.state.money -= G.producerCost(p);',
    '<rect id="key-top" x="48" y="38"',
  ],
};
